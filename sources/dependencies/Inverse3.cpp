 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Oct 24 14:53:42 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Inverse3
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                position
...
#define SOURCEFILES                    "__SFB__LIB_PATH C:\Users\biom\Desktop\Alec- Undergrad\SYSC 4906 Lab Info\HardwareAPI_Simulink\HardwareAPI_Simulink\HardwareAPI__SFB__INC_PATH C:\Users\biom\Desktop\Alec- Undergrad\SYSC 4906 Lab Info\HardwareAPI_Simulink\HardwareAPI_Simulink\HardwareAPI__SFB__Haply.HardwareAPI.lib"
...
extern void Inverse3_Start_wrapper(void **pW,
  SimStruct *S);
extern void Inverse3_Outputs_wrapper(const real32_T *force,
  real32_T *position,
  real32_T *velocity,
  void **pW,
  SimStruct *S);
extern void Inverse3_Terminate_wrapper(void **pW,
  SimStruct *S);
...
{
  void **pW = ssGetPWork(S);
  const real32_T *force = (real32_T *) ssGetInputPortRealSignal(S, 0);
  real32_T *position = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real32_T *velocity = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  Inverse3_Outputs_wrapper(force, position, velocity, pW, S);
}
...
{
  void **pW = ssGetPWork(S);
  Inverse3_Terminate_wrapper(pW, S);
}
